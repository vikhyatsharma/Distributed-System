...
public class GETClient {
    ...
    public static void main(String[] args) {
        ...
        if (args.length > 1) test = args[1]; // Storing the test number in the variable

        if (test.equals("testcase_8")) { // If we are testing then we will use this code

            GETClient obj = new GETClient(); // Creates an object of this class
            System.out.println("LamportClock:" + obj.clock.get_LamportClock());  // Prining Initial value of lamport clock
            ...
            try {
                        ...
                        System.out.println("LamportClock:" + obj.clock.get_LamportClock()); // Prining out lamport clock to check if they are working
